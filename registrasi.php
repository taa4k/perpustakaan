            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-gradient-danger">
                        <img src="asset/img/undraw_profile_1.svg">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="proses/registrasi_post.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password"
                                            class="form-control form-control-user <?= (isset($_SESSION['msg-pass-conf']))?"is-invalid":null ?>"
                                ...
                                <Button name="bttn" type="submit" class="btn btn-danger btn-user btn-block">
                                    create account!
                                </Button>
                            </form>
                            <br>
